...
class Client:
    ...
    def __init__(
        ...
        self._session = (
            requests.Session() if use_session else requests
        )  # session to use in requests
        self.tokens = Tokens(
            self,
            app_key,
            app_secret,
        ...
        def checker():
            while True:
                if self.tokens.update_tokens() and use_session:
                    self._session = (
                        requests.Session()
                    )  # make a new session if the access token was updated
                time.sleep(30)
    ...
    def option_chains(
        ...
        strike: Any = None,
        range: str | None = None,
        fromDate: datetime.datetime | str | None = None,
        toDate: datetime.datetime | str | None = None,
        volatility: Any = None,
    ...
    def movers(
        self, symbol: str, sort: str | None = None, frequency: Any = None
    ) -> requests.Response:
        """
    ...
    def market_hours(
        self, symbols: list[str], date: datetime.datetime | str | None = None
    ) -> requests.Response:
        """
    ...
    def market_hour(
        self, market_id: str, date: datetime.datetime | str | None = None
    ) -> requests.Response:
        """
